  ...
  renderPage() {
    return (
      <ScrollView style={{flex: 1}}>
        ...
        <ListRow style={{borderWidth:0}} detail={<Label style={{color: '#8a6d3b', fontSize: 25 }} text='Tender'/>} />

        <ListRow  detail={<Input style={{width: 325, borderWidth:0}} size='lg' placeholder="Enter Your Email" value={this.state.email} onChangeText={text => this.setState({email: text})} />} bottomSeparator='full' />
        <ListRow  detail={<Input style={{width: 325, borderWidth:0}} size='lg' placeholder="Enter Your Password" value={this.state.password} onChangeText={text => this.setState({password: text})} secureTextEntry={true} />} bottomSeparator='full' />
