    ...
    return (
      <ScrollView style={{flex: 1}}>
        ...
        <View style={{height: 20}} />
         ...
         <ListRow  detail={<Input style={{width: 325 ,borderWidth:1,borderColor:'#595959'}} size='lg' placeholder="Enter Your Full Name"  value={this.state.fullname} onChangeText={text => this.setState({fullname: text})} />} bottomSeparator='full' />
        <ListRow  detail={<Input style={{width: 325,borderWidth:1,borderColor:'#595959'}} size='lg'  placeholder="Enter Your Email" value={this.state.Email} onChangeText={text => this.setState({email: text})} />} bottomSeparator='full' />
        <View style={{height: 20}} />
        <ListRow  detail={<Input style={{width: 325,borderWidth:1,borderColor:'#595959'}} size='lg'  placeholder="Enter Password" value={this.state.Password} onChangeText={text => this.setState({password: text})}  secureTextEntry={true}/>} bottomSeparator='full' />
        <ListRow  detail={<Input style={{width: 325,borderWidth:1,borderColor:'#595959'}} size='lg'  placeholder="ReEnter Your Password" value={this.state.reenterpassword} onChangeText={text => this.setState({reenterpassword: text})} secureTextEntry={true}/>} bottomSeparator='full' />
